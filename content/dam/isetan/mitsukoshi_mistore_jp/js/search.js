                ...
                data = data.filter(function (elem) { // ジャンル
                    ...
                    if (targetCondition[0] == 'all' || targetCondition.length === 0) {
                        ...
                        for (var j in elem.optionTag) {
                            ...
                            var targetConditionStr = targetCondition.sort().toString();
                            var optionTagIdArrStr = optionTagIdArr.sort().toString();
                            if (optionTagIdArrStr.indexOf(targetConditionStr) >= 0) {
                                return true;
                            }
                        }
                    }
