    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i in data) {
                ...
                if (typeof data[i].categoryTag[0] != "undefined") {
                    categoryTagId = data[i].categoryTag[0].id;
                }
                if (typeof data[i].categoryTag[0] != "undefined") {
                    categoryTagTitle = data[i].categoryTag[0].title;
                }
                if (typeof data[i].floorTag[0] != "undefined") {
                    floorTagId = data[i].floorTag[0].id;
                }
